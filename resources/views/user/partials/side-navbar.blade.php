        ...
        <div class="row mb-2">
          <div class="col-12">
            ...
            <div class="form-group py-0">
              <input name="term" type="text" class="form-control  sidebar-search" placeholder="Search Menu Here...">
            </div>
        ...
        @if (!is_null($package) && (in_array('Subdomain', $permissions) || in_array('Custom Domain', $permissions)) && (is_null(Auth::guard('web')->user()->admin_id) || (is_array($roleBasedPermission) && in_array('Domains & URLs', $roleBasedPermission))))
          <li class="nav-item
            ...
            <div class="collapse
                  ...
                  @elseif(request()->path() == 'user/subdomain') show @endif" id="domains">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
              ...
              @elseif(request()->path() == 'user/pos/payment-methods') show @endif" id="pos">
              <ul class="nav nav-collapse">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
              ...
              @elseif(request()->path() == 'user/t/timeframes') show @endif" id="orderManagement">
              <ul class="nav nav-collapse">
                <li class="
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
                          ...
                          @elseif(request()->is('user/product/*/edit')) show @endif" id="category">
              <ul class="nav nav-collapse">
                <li class="
                  @if (request()->path() == 'user/category') active
                ...
                <li class=" @if (request()->path() == 'user/subcategory') active
                @elseif(request()->is('user/subcategory/*/edit')) active @endif">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
                              ...
                              @elseif(request()->path() == 'user/table/section') show @endif" id="reserveSet">
              <ul class="nav nav-collapse">
                <li class="
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
                      ...
                      @elseif(request()->path() == 'user/offline/gateways') show @endif" id="gateways">
              <ul class="nav nav-collapse">
        ...
        @if (!is_null($package) && is_null(Auth::guard('web')->user()->admin_id) && (is_array($roleBasedPermission) && in_array('Table QR Builder', $roleBasedPermission) || (is_array($roleBasedPermission) && in_array('Settings', $roleBasedPermission))))
              ...
              <li class="nav-item
                ...
                <div class="collapse
                  ...
                  @elseif(request()->routeIs('user.email.editTemplate')) show @endif" id="basic">
                  <ul class="nav nav-collapse">
                    ...
                    <li class="submenu">
                      <a data-toggle="collapse" href="#emailset" aria-expanded="{{ request()->path() == 'user/mail/information' ||
          ...
          : 'false' }}">
                      ...
                      <div class="collapse {{ request()->path() == 'user/mail/information' ||
          request()->path() == 'user/email-templates' ||
          request()->routeIs('user.email.editTemplate')
          ? 'show'
          : '' }}" id="emailset">
                        <ul class="nav nav-collapse subnav">
                          ...
                          <li class="@if (request()->path() == 'user/email-templates') active
                          @elseif(request()->routeIs('user.email.editTemplate')) active @endif">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
              ...
              @elseif(request()->path() == 'user/pushnotification/send') show @endif" id="pushNotification">
              <ul class="nav nav-collapse">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
                      ...
                      @elseif(request()->path() == 'user/mail/subscriber') show @endif" id="subscribers">
              <ul class="nav nav-collapse">
        ...
        @if (
          ...
          <li class="nav-item
            ...
            <div class="collapse
              ...
              @elseif(request()->is('user/admin/*/edit')) show @endif" id="adminsManagement">
              <ul class="nav nav-collapse">
                <li class="
                  @if (request()->path() == 'user/roles') active
